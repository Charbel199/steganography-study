...
def DCT_ENCRYPT(src,dest,message):
    NUM_CHANNELS = 3
    COVER_IMAGE_FILEPATH  = "./"+src # Choose your cover image (PNG)
    STEGO_IMAGE_FILEPATH  = "./"+dest
    SECRET_MESSAGE_STRING = message
    if not SECRET_MESSAGE_STRING:
        with open('story.txt', 'r') as file:
            SECRET_MESSAGE_STRING = file.read().replace('\n', '')
    # ============================================================================= #
    # ============================================================================= #
